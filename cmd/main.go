...
import (
	...
	"github.com/DvdChe/ztnp/internal/controller"
...
func init() {
	...
	utilruntime.Must(ztnpv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "9b227f87.ztnp.io",
	...
	if err := (&controller.SymmetricRuleReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "SymmetricRule")
		os.Exit(1)
	}
